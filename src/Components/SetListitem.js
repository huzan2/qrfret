    ...
    >
      <div className="flex min-w-0 gap-x-5 w-full">
        <div className="min-w-0 w-full flex-col gap-3">
          <p className="font-bold flex items-center text-lg flex justify-center">
            {item.number}
          </p>
          <p className="font-bold leading-6 mb-2 text-xl flex justify-center flex-wrap gap-1" onClick={onClickItem}>
